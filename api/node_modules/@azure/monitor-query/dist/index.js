...
class QueryImpl {
     ...
     */
    batch(body, options) {
        return this.client.sendOperationRequest({ body, options }, batchOperationSpec$1);
    }
    /**
     * Executes an Analytics query for data in the context of a resource.
     * [Here](https://learn.microsoft.com/azure/azure-monitor/logs/api/azure-resource-queries) is an
...
const serializer$5 = coreClient__namespace.createSerializer(Mappers$4, /* isXml */ false);
...
const batchOperationSpec$1 = {
    ...
    headerParameters: [accept$4, contentType$2],
    mediaType: "json",
    serializer: serializer$5
};
...
// Operation Specifications
const serializer$4 = coreClient__namespace.createSerializer(Mappers$4, /* isXml */ false);
...
function convertTimespanToInterval(timespan) {
    if (coreUtil.isObjectWithProperties(timespan, ["startTime", "endTime", "duration"])) {
        throw new TypeError("Invalid Timespan - contains startTime, endTime, and duration.");
    }
    if (coreUtil.isObjectWithProperties(timespan, ["startTime", "endTime"])) {
        return `${timespan.startTime.toISOString()}/${timespan.endTime.toISOString()}`;
    }
    else if (coreUtil.isObjectWithProperties(timespan, ["startTime", "duration"])) {
        return `${timespan.startTime.toISOString()}/${timespan.duration}`;
    }
    else if (coreUtil.isObjectWithProperties(timespan, ["duration", "endTime"])) {
        return `${timespan.duration}/${timespan.endTime.toISOString()}`;
    }
    else if (coreUtil.isObjectWithProperties(timespan, ["duration"])) {
...
function convertRequestForMetrics(metricNames, queryMetricsOptions) {
    ...
    const { orderBy, aggregations, metricNamespace, timespan, granularity, rollUpBy } = queryMetricsOptions, rest = tslib.__rest(queryMetricsOptions, ["orderBy", "aggregations", "metricNamespace", "timespan", "granularity", "rollUpBy"]);
 ...
 */
exports.KnownMonitorAudience = void 0;
...
})(exports.KnownMonitorAudience || (exports.KnownMonitorAudience = {}));
/**
 * Known values for Monitor Audience
 */
exports.KnownMonitorLogsQueryAudience = void 0;
...
})(exports.KnownMonitorLogsQueryAudience || (exports.KnownMonitorLogsQueryAudience = {}));
/**
 * Known values for Monitor Audience
 */
exports.KnownMonitorMetricsQueryAudience = void 0;
...
})(exports.KnownMonitorMetricsQueryAudience || (exports.KnownMonitorMetricsQueryAudience = {}));
...
class LogsQueryClient {
    ...
    constructor(tokenCredential, options) {
        const scope = (options === null || options === void 0 ? void 0 : options.audience)
            ...
            : `${exports.KnownMonitorLogsQueryAudience.AzurePublicCloud}/.default`;
...
})(KnownMetricUnit$2 || (KnownMetricUnit$2 = {}));
...
var Mappers$3 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ErrorAdditionalInfo: ErrorAdditionalInfo$2,
    ErrorContract: ErrorContract$1,
    ErrorResponse: ErrorResponse$3,
    LocalizableString: LocalizableString$2,
    ...
    TimeSeriesElement: TimeSeriesElement$1
});
...
class MetricsImpl {
    ...
    listAtSubscriptionScope(subscriptionId, region, options) {
        return this.client.sendOperationRequest({ subscriptionId, region, options }, listAtSubscriptionScopeOperationSpec$1);
    }
    /**
...
const listAtSubscriptionScopeOperationSpec$1 = {
    ...
    urlParameters: [$host$2, subscriptionId$2],
...
const listAtSubscriptionScopePostOperationSpec = {
    ...
    urlParameters: [$host$2, subscriptionId$2],
    headerParameters: [accept$3, contentType$1],
    mediaType: "json",
    serializer: serializer$3
};
 ...
 */
/** @internal */
let MonitorManagementClientContext$2 = class MonitorManagementClientContext extends coreClient__namespace.ServiceClient {
    /**
 ...
 */
/** @internal */
let MonitorManagementClient$2 = class MonitorManagementClient extends MonitorManagementClientContext$2 {
    /**
 ...
 */
/** Known values of {@link ApiVersion20240201} that the service accepts. */
var KnownApiVersion20240201$2;
(function (KnownApiVersion20240201) {
    /** Api Version '2024-02-01' */
    KnownApiVersion20240201["TwoThousandTwentyFour0201"] = "2024-02-01";
})(KnownApiVersion20240201$2 || (KnownApiVersion20240201$2 = {}));
...
const listAtSubscriptionScopeOperationSpec = {
    ...
    urlParameters: [$host$1, subscriptionId$1],
...
const listOperationSpec$1 = {
    ...
    queryParameters: [apiVersion$2, metricnamespace$1],
 ...
 */
/** @internal */
let MonitorManagementClientContext$1 = class MonitorManagementClientContext extends coreClient__namespace.ServiceClient {
    /**
     * Initializes a new instance of the MonitorManagementClientContext class.
     * @param apiVersion Api Version
     * @param options The parameter options
 ...
 */
/** @internal */
let MonitorManagementClient$1 = class MonitorManagementClient extends MonitorManagementClientContext$1 {
    /**
     * Initializes a new instance of the MonitorManagementClient class.
     * @param apiVersion Api Version
     * @param options The parameter options
 ...
 */
/** Known values of {@link ApiVersion20240201} that the service accepts. */
var KnownApiVersion20240201$1;
(function (KnownApiVersion20240201) {
    /** Api Version '2024-02-01' */
    KnownApiVersion20240201["TwoThousandTwentyFour0201"] = "2024-02-01";
})(KnownApiVersion20240201$1 || (KnownApiVersion20240201$1 = {}));
...
const listOperationSpec = {
    ...
    queryParameters: [apiVersion$1, startTime],
...
class MetricsQueryClient {
    ...
    constructor(tokenCredential, options) {
        const scope = (options === null || options === void 0 ? void 0 : options.audience)
            ? `${options.audience}/.default`
            : `${exports.KnownMonitorMetricsQueryAudience.AzurePublicCloud}/.default`;
        const packageDetails = `azsdk-js-monitor-query/${SDK_VERSION}`;
        const userAgentPrefix = (options === null || options === void 0 ? void 0 : options.userAgentOptions) && (options === null || options === void 0 ? void 0 : options.userAgentOptions.userAgentPrefix)
            ? `${options === null || options === void 0 ? void 0 : options.userAgentOptions.userAgentPrefix} ${packageDetails}`
            : `${packageDetails}`;
        ...
        this._metricsClient = new MonitorManagementClient$2(KnownApiVersion20240201$3.TwoThousandTwentyFour0201, serviceClientOptions);
        this._definitionsClient = new MonitorManagementClient$1(KnownApiVersion20240201$2.TwoThousandTwentyFour0201, serviceClientOptions);
        this._namespacesClient = new MonitorManagementClient(KnownApiVersion20240201$1.TwoThousandTwentyFour0201, serviceClientOptions);
    }
    /**
    ...
    listSegmentOfMetricDefinitions(resourceUri_1) {
        return tslib.__asyncGenerator(this, arguments, function* listSegmentOfMetricDefinitions_1(resourceUri, options = {}) {
    ...
    listItemsOfMetricDefinitions(resourceUri, options) {
        return tslib.__asyncGenerator(this, arguments, function* listItemsOfMetricDefinitions_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listSegmentOfMetricDefinitions(resourceUri, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    if (segment) {
    ...
    listSegmentOfMetricNamespaces(resourceUri_1) {
        return tslib.__asyncGenerator(this, arguments, function* listSegmentOfMetricNamespaces_1(resourceUri, options = {}) {
    ...
    listItemsOfMetricNamespaces(resourceUri, options) {
        return tslib.__asyncGenerator(this, arguments, function* listItemsOfMetricNamespaces_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listSegmentOfMetricNamespaces(resourceUri, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    if (segment) {
...
const batchOperationSpec = {
    ...
    urlParameters: [endpoint, subscriptionId],
 ...
 */
/** @internal */
class AzureMonitorMetricBatchContext extends coreClient__namespace.ServiceClient {
    /**
...
class MetricsClient {
    ...
    options) {
        const scope = (options === null || options === void 0 ? void 0 : options.audience)
            ? `${options.audience}/.default`
            : `${exports.KnownMonitorAudience.AzurePublicCloud}/.default`;
        const packageDetails = `azsdk-js-monitor-query/${SDK_VERSION}`;
        const userAgentPrefix = (options === null || options === void 0 ? void 0 : options.userAgentOptions) && (options === null || options === void 0 ? void 0 : options.userAgentOptions.userAgentPrefix)
            ? `${options === null || options === void 0 ? void 0 : options.userAgentOptions.userAgentPrefix} ${packageDetails}`
            : `${packageDetails}`;
        ...
        this._metricBatchClient = new AzureMonitorMetricBatch(this._baseUrl, KnownApiVersion20240201.TwoThousandTwentyFour0201, serviceClientOptions);
    }
    /**
